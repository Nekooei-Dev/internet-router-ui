...
from backend.routes.helpers import (
    ...
    remove_user_mangle, add_user_mangle, apply_table_routes,
    get_interface_gateways, get_default_route,
        ...
        # تغییر اینترنت پیش‌فرض
            ...
            if iface not in gateways_map:
                ...
                try:
                    ...
                    # حذف روت پیش‌فرض موجود برای main
